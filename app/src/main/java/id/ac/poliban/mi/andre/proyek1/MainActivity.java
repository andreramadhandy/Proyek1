package id.ac.poliban.mi.andre.proyek1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //letakkan data pada intent dengan ke "filename" data yang dikirim adalah data index "name"
                intent.putExtra("filename", data.get("name").toString());
                //menampilkan pesan "You clicked" dan list yang telah di klik
                Toast.makeText(MainActivity.this, "You clicked " + data.get("name"), Toast.LENGTH_SHORT).show();
                //menjalaknkan activity sesuai activity yang telah ditentukan melalui intent (InsertAndViewActivity)
                startActivity(intent);
            }
        });

        listView.setOnItemLongClickListener((parent, view, position, id) -> {
            //tangkap posisi item yang telah di-long click dan berikan data
            Map<String, Object> data = (Map<String, Object>) parent.getAdapter().getItem(position);
            //panggil method tampikanDialogKonfirmasiHpusCatatan dan kirim item list sebagai parameter
